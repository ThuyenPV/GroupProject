<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="GroupProject.Index" MasterPageFile="~/Customers.Master" %>

<%--<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="GroupProject.CustomerDB.Index" MasterPageFile="~/Customers.Master" %>--%>
...
<asp:Content runat="server" ContentPlaceHolderID="CustomerContent">
    ...
    <body>
        ...
        <form id="form" runat="server" class="content">
            <!-- slider Area Start -->
                            ...
                            <div class="row d-flex align-items-center justify-content-between">
                                ...
                                <div class="col-xl-5 col-lg-5 col-md-5 col-sm-8">
                                    <div class="hero__caption">
                                        ...
                                        <h1 data-animation="fadeInRight" data-delay=".6s">Winter
                                        <br>
                                            Collection</h1>
                ...
                <div class="container">
                    ...
                    <div class="tab-content" id="nav-tabContent">
                        ...
                        <asp:Repeater ID="rptFilter" runat="server">
                            <ItemTemplate>
                                <asp:HiddenField ID="hdParentsID" Value='<%# Eval("product_id") %>' runat="server" />
                                        ...
                                        <div class="col-xl-4 col-lg-4 col-md-6">
                                            <div class="single-product mb-60">
                                                ...
                                                <div class="product-caption">
                                                    ...
                                                    <h4><a href="DetailProducts.aspx?id=<%#Eval("product_id") %>"><%#Eval("product_name")%></a></h4>
                                                    <div class="price">
                                                        <ul>
                                                            <li>$<%#Eval("list_price")%></li>
